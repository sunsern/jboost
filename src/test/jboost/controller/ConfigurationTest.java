...
/**
 * This class is for testing Configuration.
 * It reads various data type from simulated command lines.
 * @author cschavis
 */
public class ConfigurationTest extends TestCase {
  ...
  /**
   * Tests parseArgv() make sure that parseArgv() throws the expected exceptions.
   */
  ...
  /**
   * Tests parseCommandString() which uses the parseStringTokenizer() This test
  ...
  /**
   * Tests addOption(), addValid(), isValid(), safeAddOption().
   */
